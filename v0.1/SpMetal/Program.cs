...
namespace BdsSoft.SharePoint.Linq.Tools.SpMetal
{
    ...
    internal class Args
    {
        ...
        internal static Args Parse(string[] args)
        {
            ...
            //
            // Out can optionally be empty; in that case, take the lists's name suffixed with .cs.
            //
    ...
    class Program
    {
                ...
                if (!hidden && !fromBaseType)
                {
                    ...
                    if (bclType != null)
                    {
                        ...
                        if (additional)
                        {
                            ...
                            extra.AppendFormat(", OtherChoice = \"{0}\"", helper);
                        }
                ...
                case "MultiChoice":
                    {
                        ...
                        enums.Add(String.Format(ENUM, name, sb.ToString().TrimEnd(' ', ','), flags ? "[Flags] " : ""));
        ...
        /// </summary>
        /// <example><![CDATA[
        /// [Flags] enum Beverages : uint { Coke = 1, Beer = 2, Milk = 4, Coffee = 8, Wine = 16, Other = 32 }
...
";
        ...
        /// /// First name
        /// /// </summary>
        /// [Field("First name", Type = "Text", ID = "f5164cc0-8a1b-423d-8669-e86bb65a3118")]
