...
namespace Tests
{
    ...
    public class UnitTests
    {
        ...
        public void Choice()
        {
            ...
            using (new SelfDestructingList() { List = lst })
            {
                //
                // Add fields.
                //
        ...
        public void LookupSubquery()
        {
            ...
            //
            SelfDestructingList child, parent;
        ...
        private void GetLookupLists(out SelfDestructingList child, out SelfDestructingList parent)
        {
            //
            // Child list.
            //
            ...
            // Parent list.
            //
            parent = new SelfDestructingList() { List = Test.CreateList<LookupParent>(site.RootWeb) };
            parent.List.Fields.AddLookup("Child", child.List.ID, false);
            parent.List.Update();
            SPFieldLookup lookup = new SPFieldLookup(parent.List.Fields, "Child");
            ...
            // Add child items.
            //
            SPListItem c = child.List.Items.Add();
            c["Title"] = "Child 1";
            c["Number"] = 1;
            c.Update();
            c = child.List.Items.Add();
            c["Title"] = "Child 2";
            c["Number"] = 2;
            c.Update();
            c = child.List.Items.Add();
            ...
            // Add parent items.
            //
            SPListItem p = parent.List.Items.Add();
            p["Title"] = "Parent 11";
            p["Child"] = "1;#Child 1";
            p.Update();
            p = parent.List.Items.Add();
            p["Title"] = "Parent 12";
            p["Child"] = "1;#Child 1";
            p.Update();
            p = parent.List.Items.Add();
        ...
        private void GetLookupMultiLists(out SelfDestructingList child, out SelfDestructingList parent)
        {
            //
            // Child list.
            //
            ...
            // Parent list.
            //
            parent = new SelfDestructingList() { List = Test.CreateList<LookupMultiParent>(site.RootWeb) };
            parent.List.Fields.AddLookup("Childs", child.List.ID, false);
            parent.List.Update();
            SPFieldLookup lookup = new SPFieldLookup(parent.List.Fields, "Childs");
            lookup.LookupField = "Title";
        ...
        public void DateTime()
        {
            ...
            //
            using (var lst = Test.Create<DateTimeTest>(site.RootWeb))
            {
                //
                // Add items.
                //
        ...
        public void DateRangesOverlap()
        {
            ...
            //
            using (var lst = Test.Create<DateRangesOverlapTest>(site.RootWeb))
            {
                //
                // Add items.
                //
        ...
        public void Url()
        {
            ...
            // Create list UrlTest.
            //
            using (var lst = Test.Create<UrlTest>(site.RootWeb))
            {
                //
                // Add items.
                //
        ...
        public void RowLimit()
        {
            ...
            //
            using (var lst = Test.Create<RowLimit>(site.RootWeb))
            {
                //
                // Add items.
                //
